...
export default function Loader({ width }: props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width={ width || '200px' }>
      <circle fill="#E4E4E4" stroke="#E4E4E4" strokeWidth="15" r="15" cx="35" cy="100">
      ...
      <circle fill="#E4E4E4" stroke="#E4E4E4" strokeWidth="15" opacity=".8" r="15" cx="35" cy="100">
      ...
      <circle fill="#E4E4E4" stroke="#E4E4E4" strokeWidth="15" opacity=".6" r="15" cx="35" cy="100">
      ...
      <circle fill="#E4E4E4" stroke="#E4E4E4" strokeWidth="15" opacity=".4" r="15" cx="35" cy="100">
      ...
      <circle fill="#E4E4E4" stroke="#E4E4E4" strokeWidth="15" opacity=".2" r="15" cx="35" cy="100">
